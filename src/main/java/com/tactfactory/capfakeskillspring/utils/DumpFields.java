package com.tactfactory.capfakeskillspring.utils;
...
public class DumpFields {
	public static <T> ArrayList<String> inspectBaseAttribut(Class<T> klazz) {
		...
		while (superClass.getSuperclass() != BaseEntity.class
	...
	// Recupere tous les attributs et informations
		public static ArrayList<String> fieldsToNameArray(ArrayList<Field> fields) {
	...
	public static <O extends BaseEntity> Class<?> getAssociatedDB(O item) {
